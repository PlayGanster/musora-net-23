document.addEventListener('DOMContentLoaded', function() {
    ...
    var areas = [
        ...
        { name: 'Фестивальный',       lat: '45.0480', lng: '39.0050', zoom: '13', desc: 'Восточный жилой район — вывоз строительного и бытового мусора' },
        { name: 'Юбилейный',          lat: '45.0600', lng: '39.0000', zoom: '13', desc: 'Северный жилой район — регулярный вывоз и разбор завалов' },
        { name: 'Прикубанский',       lat: '45.0200', lng: '38.9600', zoom: '13', desc: 'Юго-запад у Кубани — работаем с объёмным мусором' },
        { name: 'Пашковский',         lat: '45.0230', lng: '39.0950', zoom: '13', desc: 'Пригород на востоке — вывоз на дачах и частном секторе' },
        { name: 'Западный обход',     lat: '45.0900', lng: '38.9120', zoom: '12', desc: 'Промышленная зона вдоль трассы — крупные объёмы' },
        { name: 'Музыкальный',        lat: '45.0400', lng: '38.9650', zoom: '13', desc: 'Центр города — аккуратный вывоз вручную' },
        { name: 'Черемушки',          lat: '45.0650', lng: '38.9750', zoom: '13', desc: 'Северный район — вывоз после ремонта и капремонта' },
        { name: 'Комсомольский',      lat: '45.0350', lng: '38.9850', zoom: '13', desc: 'Центральный район — бытовой и строительный мусор' },
        { name: 'ГМР',                lat: '45.0550', lng: '38.9550', zoom: '13', desc: 'Заводская зона на севере — промышленные отходы' },
        { name: 'Российский',         lat: '45.0450', lng: '38.9950', zoom: '13', desc: 'Восточный жилой комплекс — вывоз после отделки' },
        { name: 'Славянский',         lat: '45.0630', lng: '38.9280', zoom: '13', desc: 'Северный район — бытовой мусор и садовые отходы' },
        ...
        { name: 'Яблоновский',        lat: '44.9900', lng: '38.9450', zoom: '13', desc: 'Пригород на западе — вывоз на дачах и стройках' },
        { name: 'Новая Адыгея',       lat: '45.0250', lng: '38.9330', zoom: '13', desc: 'Пригород — бытовой и строительный мусор' },
